...
$notification.post("3G/LTE Tracking acount user/pass false‼️", "", "");
//console.log(data);
}
}
}
...
if(obj["errorCode"] === "0"){
var data= obj["data"][0];
$notification.post("3G/LTE Tracking: " + data["pack_name"], "",  "Remain: " + data["remain"] +"( ~" + Math.round(data["remain_mb"]/1024) + " GB)\nExpiredate: " + data["expireDate"]);
}
else{
$notification.post("3G/LTE Tracking token expired‼️", "", "Try to login again in app My Viettel");
}
}
}
 $done();
